...
const Portfolio = () => {
    return (
        ...
        <div className="container my-5">
            <PortfolioCard thumbnail="images/mern-fullstack-social-media-app.png" cardTitle="MERN Fullstack Social Media App" description="The link below is to an example of a social media website I created using the MERN stack. In this project, I got experience using Mongo as well as deploying the site using Render. I also continued to increase my experience with Authentication/Authorization, React, Node.js and Tailwind stylings." skills="Mongo, Express React, Node.js, JavaScript, CSS, HTML" website="https://mern-fullstack-social-media-app.onrender.com/" />
