...
const Portfolio = () => {
    return (
        ...
        <div className="container my-5">
            <PortfolioCard thumbnail="images/React-Tetris-Thumbnail.png" cardTitle="Admin Dashboard Using React" description="The link below is to an example of an admin dashboard I created using React. This project was a lot of fun to create because it really really helped me to gain understanding on higher level usage of React library, as well as give me experience incorporating light and dark modes, as well as with using Material UI, Nivo Charts, Formik, Yup, Full Calendar, and Data Grid." skills="React, Node.js/Express, JavaScript, CSS, HTML" website="https://react-admin-dashboard-mv.netlify.app/" />
